...
// Load the article in a real Chromium browser so we can handle protected pages
// and pages that populate headings only after JavaScript runs.
const fs = require("fs");
...
async function main() {
  ...
  try {
    ...
    // Give client-side rendering and lazy-loaded headings a moment to appear.
